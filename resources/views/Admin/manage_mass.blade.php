...
@section('page_title', 'Manage Mass Intentions')

@section('container')

<!-- Start Back button -->
   <div class="overview-wrap">
    <h2 class="title-1">Mass Intentions</h2>
    <a href="{{url('admin/mass')}}" class="au-btn au-btn-icon au-btn--blue">
...
<!-- Start Form -->
          <div class="card">
            <div class="card-body">
                 <form action="{{route('admin.manage_mass')}}"  method="post" enctype="multipart/form-data">
